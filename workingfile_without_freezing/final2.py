...
def checkTime(startTime, endTime):
    '''
    지금이 작동해야 하는 시간인지 판별하는 함수
    stratTime, endTime은 hour와 minute으로 이루어진 정수형
    ex) 15시 30분의 경우 1530
    '''
...
def readGivenInfo():
    ...
    wanted_led_on_off = int(lines[6]) # 0은 False  1 True
